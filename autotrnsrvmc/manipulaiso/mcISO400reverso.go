...
func Mciso400rev(iso_padrao []byte) ([]byte, error) {
	...
	pedidoautoriza.DadosCanc = &modelos.IsoDe90{
		MtiOrin:    singledualmsncanc,
		StanOrin:   sy_trace,
		HhmmssOrin: mmddhhmmss,
		AcqrOrin:   acqr,
		InstFOrin:  acqrremente,
	}
	//pedidoautoriza.DadosCanc = singledualmsncanc + sy_trace + mmddhhmmss + acqr + "000000000" + acqrremente
